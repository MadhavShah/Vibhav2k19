...
public class Guest extends AppCompatActivity {
    ...
    String bucks_token ,event="marketing_roadies";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(R.drawable.mroad);
...
//        }
    ...
    public void about(View view){
        about_builder= new AlertDialog.Builder(Guest.this);
        about_builder.setMessage(R.string.about102);
    ...
    public void rules(View view){
        rules_builder= new AlertDialog.Builder(Guest.this);
        rules_builder.setMessage(R.string.rules102);
    ...
    public void judgingCriteria(View view){
        judgingCriteria_builder= new AlertDialog.Builder(Guest.this);
        judgingCriteria_builder.setMessage(R.string.judgingCriteria102);
    ...
    public void prizes(View view){
        prizes_builder= new AlertDialog.Builder(Guest.this);
        prizes_builder.setMessage(R.string.prizes102);
    ...
    public void contactUs(View view){
        contactUs_builder= new AlertDialog.Builder(Guest.this);
        contactUs_builder.setMessage(R.string.contactUs102);
